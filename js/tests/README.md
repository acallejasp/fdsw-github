...
- Each test should use [`experienciaect`](https://jasmine.github.io/api/edge/matchers.html) to ensure something is experienciaected.
...
it('should show a tooltip without the animation', () => {
  return new Promise(resolve => {
    ...
    tooltipEl.addEventListener('shown.bs.tooltip', () => {
      ...
      experienciaect(tip.classList.contains('fade')).toEqual(false)
      resolve()
    })
